...
/*
Insert into EXPORT_TABLE ("ulogin","upass","created","lastPwdChange","pwdExpired","astate","roleId","personId","authType","ipMaskAllow","ipMaskDeny","info") values ('mike','ac5c74b64b4b8352ef2f181affb5ac2a',to_timestamp('2016-11-04 11:30:35.0','null'),null,null,2,1,18,1,null,null,'Michael Zavedeev - dev account');
Insert into EXPORT_TABLE ("ulogin","upass","created","lastPwdChange","pwdExpired","astate","roleId","personId","authType","ipMaskAllow","ipMaskDeny","info") values ('nady','3949c66fdc4066377cdbd5f4a2f6c3f8',to_timestamp('2016-11-06 20:55:17.0','null'),null,null,2,1,411,1,null,null,'Ponomareva - dev account');
*/