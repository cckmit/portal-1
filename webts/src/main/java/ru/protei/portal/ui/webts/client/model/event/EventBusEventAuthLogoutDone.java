...
public class EventBusEventAuthLogoutDone extends EventBusEvent {
    ...
    public static native EventBusEventAuthLogoutDone create(boolean userInitiated) /*-{
        return {
            type: @ru.protei.portal.ui.webts.client.model.event.EventBusEventAuthLogoutDone::type,
            source: @ru.protei.portal.ui.webts.client.model.event.EventBusSource::SourcePortalUiGwt,
            payload: {
