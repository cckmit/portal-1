...
public enum En_ErrorCode {
    ...
    EMPTY_WOR_ID("WE-10008","Workers's identifier is empty."),
    ...
    EXIST_DEP("WE-10015", "Department already exist."),
    UNKNOWN_PAR_DEP("WE-10016", "Unknown parent of department."),
    UNKNOWN_HEAD_DEP("WE-10017", "Unknown head of department."),
    EXIST_CHILD_DEP("WE-10018", "The department has child departments."),
    EXIST_DEP_WOR("WE-10019", "The department has workers."),
    NOT_CREATE("WE-10020", "Can not create."),
    NOT_UPDATE("WE-10021", "Can not update."),
    NOT_DELETE("WE-10022", "Can not delete."),
    NOT_FIRE("WE-10023", "Can not fire."),
    EMPTY_PHOTO("WE-10024", "Photo is empty.");
