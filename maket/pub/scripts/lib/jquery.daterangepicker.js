...
}(function ($, moment)
{
	...
	$.fn.dateRangePicker = function(opt)
	{
		...
		function init_datepicker()
		{
			...
			box.find('.next_button').click(function()
			{
				if(!opt.stickyMonths)
					gotoNextMonth(this);
				else
			...
			box.find('.prev_button').click(function()
			{
				if(!opt.stickyMonths)
					gotoPrevMonth(this);
				else
		...
		function showSelectedInfo(forceValid,silent)
		{
			...
			if (opt.start && opt.singleDate)
			{
				...
				opt.setValue.call(selfDom, dateRange, new Date(opt.start), new Date(opt.end));
		...
		function createDom()
		{
			...
			html += '<div class="month-wrapper">'
				+'<table class="month1" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><td><div class="prev_button"></div></td><td colspan="'+_colspan+'" class="month-name"></td><td>' + (opt.singleDate || !opt.stickyMonths ? '<div class="next_button"></div>': '') + '</td></tr><tr class="week-name">'+getWeekHead()+'</thead><tbody></tbody></table>';

			if ( hasMonth2() )
			{
				html += '<div class="gap">'+getGapHTML()+'</div>'
					+'<table class="month2" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th>' + (!opt.stickyMonths ? '<span class="prev">&lt;</span>': '') + '</th><th colspan="'+_colspan+'" class="month-name"></th><th><span class="next">&gt;</span></th></tr><tr class="week-name">'+getWeekHead()+'</thead><tbody></tbody></table>'
			}
				//+'</div>'
		...
		{
			var prepend = opt.showWeekNumbers ? '<td>'+lang('week-number')+'</td>' : '';
			if (opt.startOfWeek == 'monday')
			{
				return prepend+'<td>'+lang('week-1')+'</td>\
					<td>'+lang('week-2')+'</td>\
					<td>'+lang('week-3')+'</td>\
					<td>'+lang('week-4')+'</td>\
					<td>'+lang('week-5')+'</td>\
			...
			{
				return prepend+'<td>'+lang('week-7')+'</td>\
					<td>'+lang('week-1')+'</td>\
					<td>'+lang('week-2')+'</td>\
					<td>'+lang('week-3')+'</td>\
					<td>'+lang('week-4')+'</td>\
