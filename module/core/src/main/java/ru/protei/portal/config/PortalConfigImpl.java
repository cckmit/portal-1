 ...
 */
public class PortalConfigImpl extends AbstractPropertiesReloadableConfig<PortalConfigData> implements PortalConfig
 {

    public PortalConfigImpl(String sourcePath) throws ConfigException {
        super(sourcePath);
    }
