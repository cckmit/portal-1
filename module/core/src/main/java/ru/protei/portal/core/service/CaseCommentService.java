...
//    Result<List<CaseComment>> getCaseCommentList( AuthToken token, En_CaseType caseType, CaseCommentQuery query);
    ...
    Result<CaseComment> addCaseComment( AuthToken token, En_CaseType caseType, CaseComment comment, Long personId);
    ...
    Result<CaseComment> updateCaseComment( AuthToken token, En_CaseType caseType, CaseComment comment, Long personId);
    ...
    @Auditable(value = En_AuditType.ISSUE_COMMENT_MODIFY, forCases = En_CaseType.CRM_SUPPORT)
    Result<CaseCommentSaveOrUpdateResult> updateCaseCommentWithoutEvent( AuthToken token, En_CaseType caseType, CaseComment comment, Long personId);
    ...
    Result<Boolean> removeCaseComment( AuthToken token, En_CaseType caseType, CaseComment comment, Long personId);
    ...
    @Auditable(value = En_AuditType.ISSUE_COMMENT_MODIFY, forCases = En_CaseType.CRM_SUPPORT)
    Result<Boolean> updateCaseTimeElapsedType(AuthToken token, Long caseCommentId, En_TimeElapsedType type, Long personId);
