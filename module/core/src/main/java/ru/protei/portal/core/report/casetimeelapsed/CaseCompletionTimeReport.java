...
public class CaseCompletionTimeReport implements ReportCaseTimeElapsed {

    public CaseCompletionTimeReport( Report report, ByteArrayOutputStream buffer ) {
        log.warn( "CaseComletionTimeReport(): Not implemented." );//TODO NotImplemented

    }


    private static Logger log = LoggerFactory.getLogger( CaseCompletionTimeReport.class);
    ...
    public boolean writeReport() {
        log.warn( "writeReport(): Not implemented." );//TODO NotImplemented
        return false;
    }
