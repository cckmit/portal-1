...
@Table(name="\"Resource\".Tm_Project")
public class ExternalDevProject implements LegacyEntity {
    ...
    public ExternalDevProject() {

    }

    public ExternalDevProject(DevUnit unit) {
        this.id = unit.getOldId();
        this.created = unit.getCreated();
        this.name = unit.getName();
        this.info = unit.getInfo();
    }

    public ExternalDevProject updateFrom (DevUnit unit) {
        this.info = unit.getInfo();
        this.name = unit.getName();
        return this;
    }
    ...
    public String toString() {
        return new StringBuilder("project{").append(getId()).append("/").append(getName()).append("}").toString();
    }
}
