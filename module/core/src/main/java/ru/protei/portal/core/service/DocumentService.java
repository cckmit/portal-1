...
public interface DocumentService {
    ...
    Result<Document> createDocument( AuthToken token, Document document, FileItem docFile, FileItem pdfFile);
    ...
    Result<Document> updateDocument( AuthToken token, Document document, FileItem docFile, FileItem pdfFile);
