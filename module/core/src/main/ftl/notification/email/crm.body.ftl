    ...
    <div style="margin-top: 12px">
        ...
        <div style="font-size:14px;margin-top:15px">
            <#list caseComments?reverse as caseComment>
                <div style="border-radius:5px;padding:12px;margin-bottom:5px;background:<#if caseComment.removed>#fc8686<#else><#if caseComment.changed>#dff7e2<#else>#f0f0f0</#if></#if>;">
