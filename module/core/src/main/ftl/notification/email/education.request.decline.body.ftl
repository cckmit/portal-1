...
<@set name="_educationEntryDeclined" value="${educationEntryDeclined}"/>
...
<#noparse>
    ...
    <div style="margin-top: 12px">
        <div style="padding: 5px;font-size: 14px;background:#ffeded;color:#f90000;">
            ${_educationEntryDeclined}: ${declined}
        </div>
        <table>
            <tbody>
            <tr>
