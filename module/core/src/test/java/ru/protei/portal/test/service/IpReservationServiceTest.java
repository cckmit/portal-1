...
/*    @Test
    public void testCreateAndGetSubnet () {
        ...
        Result<SearchResult<Subnet>> result = ipReservationService.getSubnets( getAuthToken(), new ReservedIpQuery() );
        ...
        Assert.assertNull(ipReservationService.removeSubnet(getAuthToken(), subnet));
    }*/
    ...
    public void testSubnet(){
        ...
        /* remove */
        Result<Long> result = ipReservationService.removeSubnet(null, subnet);
        Assert.assertNotNull(result);
    }
