...
public class ReportYtWorkTest {
    ...
    public void testNiokrNmaReport() {
        ...
        ReportYtWorkInfo info1 = new ReportYtWorkInfo(
                userEmail1,
                "niokrIssue1",
                homeCompanyName,
                niokrTime,
        ...
        ReportYtWorkInfo info2 = new ReportYtWorkInfo(
                userEmail1,
                "nmaIssue1",
                homeCompanyName,
                nmaTime,
    ...
    public void testContractsReport() {
        ...
        contract3.setNumber("contract3");
        contract3.setDateValid(new GregorianCalendar(2021, Calendar.JULY, 20, 3, 0, 0).getTime());

        Map<String, List<Contract>> contracts = new HashMap<>();
        contracts.put(customerCompanyName + "#" + contractProject1, Arrays.asList(contract1));
        contracts.put(customerCompanyName + "#" + contractProject2, Arrays.asList(contract2, contract3));
        ...
        ReportYtWorkInfo info3 = new ReportYtWorkInfo(
                userEmail1,
                "contractIssue3",
                customerCompanyName,
                contractTime3,
        ...
        ReportYtWorkCollector collector = new ReportYtWorkCollector(
                ...
                (name, project) -> contracts.get(name + "#" + project),
                persons::get,
                new GregorianCalendar(2021, Calendar.JULY, 19, 0, 59, 0).getTime(),
                homeCompany
        );
        ...
        Assert.assertEquals(3, ytWorkItem.getContractSpentTime().size());
        Assert.assertEquals(contractTime1 + contractTime3, ytWorkItem.getContractSpentTime().get("contract1").longValue());
        Assert.assertEquals(contractTime2 / 2, ytWorkItem.getContractSpentTime().get("contract2").longValue());
        Assert.assertEquals(contractTime2 / 2, ytWorkItem.getContractSpentTime().get("contract3").longValue());
