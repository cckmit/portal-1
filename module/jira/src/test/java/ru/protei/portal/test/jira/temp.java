...
import static ru.protei.portal.core.utils.JiraUtils.parseJiraImageNode;
...
//        Pattern p = Pattern.compile("![^!\\t\\n\\r(\\.|())]*!");
        ...
        if (!m.find()) {
            ...
            do {
                ...
                JiraUtils.JiraImageNode node = parseJiraImageNode(originalString);
...
//        Pattern p = Pattern.compile("![^!\\t\\n\\r]*!");
    ...
    public void testNoRegexp() {
        ...
        String[] maybeImage = str.split("!");
        for (String s : maybeImage) {
            Pattern p = Pattern.compile("[^\\t\\n\\r]+");
