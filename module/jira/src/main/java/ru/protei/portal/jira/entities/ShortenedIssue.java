...
public class ShortenedIssue implements Issue {
    ...
    public ShortenedIssue(Long id,
        ...
        this.id = id;
        try {
            this.created = new Timestamp(dateFormat.parse(created).getTime());
            this.updated = new Timestamp(dateFormat.parse(updated).getTime());
