...
public enum En_Privilege {
    ...
    DELIVERY_SPECIFICATION_VIEW(DELIVERY_SPECIFICATION, VIEW),
    DELIVERY_SPECIFICATION_CREATE(DELIVERY_SPECIFICATION, CREATE),
    DELIVERY_SPECIFICATION_EDIT(DELIVERY_SPECIFICATION, EDIT),
    DELIVERY_SPECIFICATION_REMOVE(DELIVERY_SPECIFICATION, REMOVE),
