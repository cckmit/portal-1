...
public class SiteFolderServerFilterView extends Composite implements AbstractSiteFolderServerFilterView {
    ...
    @Override
    public void setActivity(AbstractSiteFolderServerFilterActivity activity) {
    ...
    private AbstractSiteFolderServerFilterActivity activity;

    interface SiteFolderServerFilterViewUiBinder extends UiBinder<HTMLPanel, SiteFolderServerFilterView> {}
