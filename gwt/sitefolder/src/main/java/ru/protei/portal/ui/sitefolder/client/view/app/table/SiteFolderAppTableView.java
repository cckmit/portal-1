...
import ru.protei.portal.ui.sitefolder.client.activity.app.table.AbstractSiteFolderAppTableActivity;
import ru.protei.portal.ui.sitefolder.client.activity.app.table.AbstractSiteFolderAppTableView;

import java.util.Collection;
import java.util.LinkedList;

public class SiteFolderAppTableView extends Composite implements AbstractSiteFolderAppTableView {
    ...
    @Override
    public void setActivity(AbstractSiteFolderAppTableActivity activity) {
    ...
    interface SiteFolderAppTableViewUiBinder extends UiBinder<HTMLPanel, SiteFolderAppTableView> {}
