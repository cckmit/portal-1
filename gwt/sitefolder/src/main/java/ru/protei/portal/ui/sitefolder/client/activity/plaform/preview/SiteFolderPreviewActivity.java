...
public abstract class SiteFolderPreviewActivity implements Activity, AbstractSiteFolderPreviewActivity {
    ...
    @Event
    public void onShow(SiteFolderEvents.Platform.ShowPreview event) {
        event.parent.clear();
    ...
    @Inject
    AbstractSiteFolderPreviewView view;
}
