...
public class SiteFolderAppFilterView extends Composite implements AbstractSiteFolderAppFilterView {
    ...
    @Override
    public void setActivity(AbstractSiteFolderAppFilterActivity activity) {
    ...
    private AbstractSiteFolderAppFilterActivity activity;

    interface SiteFolderAppFilterViewUiBinder extends UiBinder<HTMLPanel, SiteFolderAppFilterView> {}
