...
import ru.protei.portal.ui.sitefolder.client.activity.server.table.AbstractSiteFolderServerTableActivity;
import ru.protei.portal.ui.sitefolder.client.activity.server.table.AbstractSiteFolderServerTableView;

import java.util.Collection;
import java.util.LinkedList;

public class SiteFolderServerTableView extends Composite implements AbstractSiteFolderServerTableView {
    ...
    @Override
    public void setActivity(AbstractSiteFolderServerTableActivity activity) {
    ...
    interface SiteFolderServerTableViewUiBinder extends UiBinder<HTMLPanel, SiteFolderServerTableView> {}
