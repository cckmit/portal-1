...
public abstract class SiteFolderTableActivity implements
        AbstractSiteFolderTableActivity, AbstractSiteFolderFilterActivity,
        AbstractPagerActivity, Activity
{
    ...
    @Inject
    AbstractSiteFolderTableView view;
    @Inject
    AbstractSiteFolderFilterView filterView;
    @Inject
