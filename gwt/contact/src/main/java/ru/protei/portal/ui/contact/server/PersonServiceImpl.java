...
public class PersonServiceImpl implements PersonService {
    ...
    public List<PersonShortView> getPersonViewList() throws RequestFailedException {

        log.debug( "getPesonViewList()" );

        CoreResponse< List< PersonShortView > > result = personService.shortViewList();
