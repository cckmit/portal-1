...
public abstract class EmployeeEditActivity implements AbstractEmployeeEditActivity, Activity {
    ...
    @Override
    public void onChangeEmployeeLogin() {
        ...
        if (login.isEmpty()) {
            view.setEmployeeLoginStatus(NameStatus.NONE);
        ...
        accountService.isLoginUnique(
                ...
                new FluentCallback<Boolean>()
                        .withSuccess(isUnique -> view.setEmployeeLoginStatus(isUnique ? NameStatus.SUCCESS : NameStatus.ERROR)));
    }
    ...
    private boolean isLoginValid() {
        if (Objects.equals(view.getEmployeeLoginStatus(), NameStatus.ERROR)) {
            return false;
        }
