...
public abstract class ListPage implements Activity {
    ...
    public void onAuthSuccess( AuthEvents.Success event ) {
        if ( event.profile.hasPrivilegeFor( En_Privilege.EMPLOYEE_VIEW ) ) {
            fireEvent( new MenuEvents.Add( TAB, UiConstants.TabIcons.EMPLOYEE_LIST, TAB,
                                           CrmConstants.PAGE_LINK.EMPLOYEE_LIST,
                                           DebugIds.SIDEBAR_MENU.EMPLOYEE_LIST ).withParent( CATEGORY ) );
