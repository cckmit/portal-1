...
public abstract class CardBatchPage
    ...
    public void onAuthSuccess( AuthEvents.Success event ) {
        if ( event.profile.hasPrivilegeFor( En_Privilege.CARD_BATCH_VIEW) ) {
            fireEvent( new MenuEvents.Add( TAB, UiConstants.TabIcons.CARD_BATCH, TAB,
                                           CrmConstants.PAGE_LINK.CARD_BATCH,
                                           DebugIds.SIDEBAR_MENU.CARD_BATCH).withParent(CATEGORY) );
