...
/**
 * Модель статусов партий плат
 */
public abstract class CardBatchStateOptionsModel extends LifecycleSelectorModel<CaseState> {
    ...
    public void refreshOptions() {
        caseStateController.getCaseStatesOmitPrivileges(En_CaseType.CARD_BATCH, new FluentCallback<List<CaseState>>()
                .withError(throwable -> {
