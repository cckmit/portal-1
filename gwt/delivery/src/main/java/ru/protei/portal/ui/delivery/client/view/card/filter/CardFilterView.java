package ru.protei.portal.ui.delivery.client.view.card.filter;
 ...
 */
public class CardFilterView extends Composite implements AbstractCardFilterView {
    @Inject
    public void onInit() {
    ...
    @Override
    public void setActivity( AbstractCardFilterActivity activity ) {
    ...
    interface CardFilterViewUiBinder extends UiBinder<HTMLPanel, CardFilterView> {}
}