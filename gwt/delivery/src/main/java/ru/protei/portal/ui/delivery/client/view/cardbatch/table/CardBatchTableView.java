...
public class CardBatchTableView extends Composite implements AbstractCardBatchTableView {
    ...
    private void initTable() {
        columns.add(new TypeColumn(lang));
        columns.add(new ArticleColumn(lang));
        columns.add(new BatchNumberColumn(lang));
        columns.add(new StateColumn(lang, cardStateLang));
        columns.add(new ImportanceColumn(lang));
