 ...
 * 4.0.56.1 - CRM-176 Н7овый CRM: Возможность указания затраченного времени. (исправления по визуализации)
 ...
 * 4.0.60.3 — CRM-246 Не обновляется таблица с проектами при смене региона в проекте
 * 4.0.60.4 — CRM-219 В продуктах иметь возможность видеть компоненты
 */
