 ...
 */
public class MultipleFormSelector<T> extends MultipleSelector<T> implements HasEnabled {

    public MultipleFormSelector() {
        initWidget( ourUiBinder.createAndBindUi( this ) );
        initHandlers();
    }

    public void setHeader( String label ) {
        this.label.removeStyleName(UiConstants.Styles.HIDE);
    ...
    interface SelectorUiBinder extends UiBinder< HTMLPanel, MultipleFormSelector> {}
