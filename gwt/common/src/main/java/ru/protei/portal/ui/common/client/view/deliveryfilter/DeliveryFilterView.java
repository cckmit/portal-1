...
public class DeliveryFilterView extends Composite implements AbstractDeliveryFilterView {
    ...
    @Override
    public void setActivity(AbstractDeliveryFilterActivity activity) {
    ...
    private AbstractDeliveryFilterActivity activity;

    private static FilterViewUiBinder outUiBinder = GWT.create(FilterViewUiBinder.class);

    interface FilterViewUiBinder extends UiBinder<HTMLPanel, DeliveryFilterView> {
    }
}
