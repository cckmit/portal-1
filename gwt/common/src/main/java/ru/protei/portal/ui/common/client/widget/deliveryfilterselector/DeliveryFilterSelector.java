...
public class DeliveryFilterSelector extends ButtonSelector<FilterShortView> implements SelectorWithModel< FilterShortView > {

    @Inject
    public void init( DeliveryFilterModel model ) {
        this.model = model;
    ...
    private En_DeliveryFilterType filterType;
    private String defaultValue = null;
    private DeliveryFilterModel model;
}
