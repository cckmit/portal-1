 ...
 * Модель статусов
 */
public abstract class StateModel implements AsyncSelectorModel<CaseState>, Activity {
    ...
    private SelectorDataCacheLoadHandler<CaseState> makeLoadHandler() {
        return new SelectorDataCacheLoadHandler() {
            ...
            public void loadData(int offset, int limit, AsyncCallback handler) {
                caseStateWorkflowController.getCaseStateAndWorkflowList(new AsyncCallback<CaseStateAndWorkflowList>() {
                    @Override
                    ...
                    @Override
                    public void onSuccess(CaseStateAndWorkflowList caseStateAndWorkflowList) {
                        handler.onSuccess(caseStateAndWorkflowList.getCaseStatesList());
                    }
                });
            }
        };
