...
public class UiConstants {
    ...
    public static final String ISSUE_COMMENTS_TAB_SELECTED = "issue-comments-tab-selected";
    public static final String ISSUE_HISTORIES_TAB_SELECTED = "issue-histories-tab-selected";
}
