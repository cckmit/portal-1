...
public abstract class ImportanceBtnGroupModel implements Activity {
    @Event
    ...
    private void refreshOptions() {
        ...
        importanceService.getImportanceLevels(policyService.getUserCompany().getId(), new FluentCallback<List<ImportanceLevel>>()
                .withSuccess(result -> {
                    importanceLevels.clear();
                    importanceLevels.addAll(result);
