package ru.protei.portal.ui.common.client.widget.positionselector.item;
...
public class PositionSelectorItem extends Composite implements HasValue<WorkerPosition>, HasAddHandlers, HasEditHandlers, HasClickHandlers {

    public PositionSelectorItem() {
        initWidget(ourUiBinder.createAndBindUi(this));
        initDebugIds();
    }

    @Override
    public void setValue(WorkerPosition value) {
        setValue(value, false);
    }

    @Override
    public void setValue(WorkerPosition value, boolean fireEvents) {
        workerPosition = value;

        text.setText(workerPosition.getName());
        panel.setTitle(workerPosition.getName());
    ...
    @Override
    public WorkerPosition getValue() {
    ...
    private WorkerPosition workerPosition = null;

    interface WorkerPositionViewUiBinder extends UiBinder<HTMLPanel, PositionSelectorItem> {}
    private static WorkerPositionViewUiBinder ourUiBinder = GWT.create(WorkerPositionViewUiBinder.class);
}
