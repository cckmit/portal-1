package ru.protei.portal.ui.decision.client.view.table;
...
public class OfficialTableView extends Composite implements AbstractOfficialTableView {
    ...
    private void initTable() {
        editClickColumn.setPrivilege( En_Privilege.DECISION_EDIT );
        ...
        ClickColumn<Official> infoColumn = new ClickColumn<Official>() {
            ...
            public void fillColumnValue(Element cell, Official value) {
                ...
                Date createTime = value == null ? null : value.getCreateTime();
        ...
        ClickColumn<Official> numberEmployeesColumn = new ClickColumn<Official>() {
            ...
            public void fillColumnValue(Element cell, Official value) {
                ...
                labelElement.setInnerText(value == null ? "" : value.getNumberEmployees());
    ...
    @Inject
    Lang lang;
    AttachClickColumn<Official> attachColumn = new AttachClickColumn<Official>(lang) {};
