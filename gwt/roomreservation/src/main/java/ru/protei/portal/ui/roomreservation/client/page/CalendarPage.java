...
public abstract class CalendarPage implements Activity {
    ...
    public void onAuthSuccess(AuthEvents.Success event) {
        if (event.profile.hasPrivilegeFor(En_Privilege.ROOM_RESERVATION_VIEW)) {
            fireEvent(new MenuEvents.Add(TAB, UiConstants.TabIcons.ROOM_RESERVATION_CALENDAR, TAB, DebugIds.SIDEBAR_MENU.ROOM_RESERVATION_CALENDAR).withParent(CATEGORY));
